...
use DOMNode;
use Prediggo\Type\Search\SortingOption;
 ...
 * @author Stef
 */
class ResultHandler extends \Prediggo\Type\Search\ResultHandler
{
     ...
     * @param Result $resultObj the result object to fill
     */
    private function readFilterOptions(DOMNode $filterOptionsNode, Result $resultObj)
    {
     ...
     * @param Result $resultObj the result object to fill
     */
    private function readSortingOptions(DOMNode $sortingOptionsNode, Result $resultObj)
    {
     ...
     * @param Result $resultObj the result object to fill
     */
    private function readRedirectionObjects(DOMNode $redirectionObjectsNode, Result $resultObj)
    {
